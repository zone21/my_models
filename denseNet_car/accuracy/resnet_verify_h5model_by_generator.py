...
from keras.utils.training_utils import multi_gpu_model, _get_available_devices
...
def verify_h5model(args):
    ...
    nbr_gpus = len(_get_available_devices()) - 1
    ...
    with tf.device('/cpu:0'):
        ...
        output = Dense(class_count, activation='sigmoid', name='predictions')(output)
