...
best_model_file = "./data/resnet2/resNet50_best_vehicleModel_sigmoid.h5"
weight_path = './data/InceptionV3_best_vehicleModel_404_20181006.h5'
train_path = './data/resnet2/train_file_resnet2.txt'
val_path = './data/resnet2/val_file_resnet2.txt'
...
if __name__ == "__main__":
    ...
    with tf.device('/cpu:0'):
        densenet = ResNet50(include_top=False, weights='imagenet',
                               input_tensor=None, input_shape=(IMG_WIDTH, IMG_HEIGHT, 3), pooling='avg')
        output = densenet.get_layer(index=-1).output
        output = Dropout(0.5)(output)
        output = Dense(NBR_MODELS, activation='sigmoid', name='predictions')(output)
